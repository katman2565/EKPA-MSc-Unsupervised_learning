## Notebooks - Μη επιβλεπόμενη μάθηση (συνάντηση 14/5/2026)

Αυτός ο φάκελος περιλαμβάνει μερικά βασικά notebooks για μη επιβλεπόμενη μάθηση.
Τα notebooks δείχνουν βήμα-βήμα πώς προετοιμάζουμε τα δεδομένα και πώς προχωράμε σε ανάλυση με NLP, sentence embeddings και clustering.
