...
Αυτός ο φάκελος περιλαμβάνει βασικά notebooks για μη επιβλεπόμενη μάθηση σχετικά με: προετοιμασία και καθαρισμός δεδομένων, ανάλυση με NLP, sentence embeddings και clustering.
